        ...
        <div class="relative">
            ...
            <div class="relative flex flex-col sm:w-[30rem] rounded-lg border-gray-400 bg-white shadow-lg px-4">
                <div class="flex-auto p-6">
                    ...
                    <!-- /Logo -->
                    <h4 class="mb-2 font-medium text-gray-700 xl:text-xl">Chào mừng đến với Boleno!
</h4>
                    <p class="mb-6 text-gray-500">Vui lòng đăng nhập để truy cập tài khoản của bạn</p>

                    <form id="" class="mb-4" action="#" method="POST">
                        <div class="mb-4">
                            <label for="email" class="mb-2 inline-block text-xs font-medium uppercase text-gray-700">Email HOẶC TÊN NGƯỜI DÙNG</label>
                            <input type="text" class="block min-w-full cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow" id="email" name="email-username" 
                                placeholder=" Nhập email hoặc tên người dùng của bạn" autofocus="" />
                        </div>
                        <div class="mb-4">
                            <div class="relative flex w-full flex-wrap items-stretch">
                                <label for="password" class="mb-2 inline-block text-xs font-medium uppercase text-gray-700">MẬT KHẨU</label>

                                <input type="password" id="password" class="relative block min-w-full cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow" name="password" placeholder="············" />
                            </div>
                        </div>
                        <div class="mb-4">
                            <div class="block">
                        ...
                        <div class="mb-4">
                            <a href="/" class="mt-4 w-full mx-auto
     block cursor-pointer rounded-lg bg-gradient-to-r 
     from-sky-400 to-blue-500 text-center font-bold text-white pt-3 pb-3 text-white shadow-lg hover:bg-blue-400">Đăng nhập</a>
                        </div>
                    </form>
