     ...
     <nav aria-label="Header Navigation" class=" peer-checked:max-h-60
         ...
         <a href="/Orders" class="flex mr-2 items-center space-x-6 space-y-2 lg:my-0 lg:ml-auto lg:space-x-8 lg:space-y-0">
             <img class="w-10 h-10 object-contain" src="https://cdn-icons-png.freepik.com/512/10125/10125293.png?ga=GA1.1.1507487213.1702549666"/>
         </a>
         <a href="/SignIn" class="flex mr-2 items-center space-x-6 space-y-2 lg:my-0 lg:ml-auto lg:space-x-8 lg:space-y-0">
             <img class="w-10 rounded-full object-contain h-10" src="https://previews.123rf.com/images/giamportone/giamportone2103/giamportone210300889/166486342-login-icon-vector-user-symbol-simple-linear-pictogram-user-interface-account-log-in.jpg"/>
         </a>
     </nav>
 </header>